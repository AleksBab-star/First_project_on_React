export default function About_me(){
    return (
        <section className="bg-[#222831] flex items-center justify-around gap-15 h-[850px] px-10 max-md:flex max-md:flex-col max-md:px-4">
            <div className="h-">
                <h1 className="font-['Poppins'] font-bold text-white text-[64px]">About <span className="text-[#00ADB5]">me</span></h1>
